...
namespace SnowballFight.Items.Armor.SnowNinjaArmor
{
	...
	public class SnowNinjaHood : ModItem
	{
		...
		public override bool IsArmorSet(Item head, Item body, Item legs) {
			return body.type == ModContent.ItemType<SnowNinjaShirt>() && legs.type == ModContent.ItemType<SnowNinjaPants>();
		}

		public override void UpdateArmorSet(Player player) {
			player.setBonus = "2% increased Snowball gloves ranged crit chance"
				+ "\nIncreases Snowball minion damage by 5%"
				+ "\n10% increased movement speed when in Snow Biome";
